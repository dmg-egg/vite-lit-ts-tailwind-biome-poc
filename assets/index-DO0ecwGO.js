...
const lt = (s) => new at(typeof s == "string" ? s : s + "", void 0, W),
	L = (s, ...t) => {
		const e =
			s.length === 1
				? s[0]
...
const {
	...
	Q = m.trustedTypes,
	Et = Q ? Q.emptyScript : "",
	I = m.reactiveElementPolyfillSupport,
	E = (s, t) => s,
	N = {
		toAttribute(s, t) {
			switch (t) {
	...
	Z = (s, t) => !yt(s, t),
	X = { attribute: !0, type: String, converter: N, reflect: !1, hasChanged: Z };
...
class v extends HTMLElement {
	...
	static getPropertyDescriptor(t, e, o) {
		const { get: i, set: r } = _t(this.prototype, t) ?? {
			get() {
				return this[e];
			},
			set(n) {
	...
	static finalize() {
		...
		if (
			((this.finalized = !0), this._$Ei(), this.hasOwnProperty(E("properties")))
		) {
		...
		if (t !== null) {
			...
			if (e !== void 0)
				for (const [o, i] of e) this.elementProperties.set(o, i);
		}
		this._$Eh = new Map();
			...
			const n = o.getPropertyOptions(i),
				l =
					typeof n.converter == "function"
						...
						: ((r = n.converter) == null ? void 0 : r.fromAttribute) !== void 0
							? n.converter
							: N;
			(this._$Em = i),
				(this[i] = l.fromAttribute(e, n.type)),
				(this._$Em = null);
		}
	}
	requestUpdate(t, e, o) {
		if (t !== void 0) {
			if (
				(o ?? (o = this.constructor.getPropertyOptions(t)),
				!(o.hasChanged ?? Z)(this[t], e))
			)
				return;
			this.P(t, e, o);
		}
...
(v.elementStyles = []),
	...
	(v[E("elementProperties")] = new Map()),
	(v[E("finalized")] = new Map()),
	I == null || I({ ReactiveElement: v }),
...
const S = globalThis,
	T = S.trustedTypes,
	tt = T ? T.createPolicy("lit-html", { createHTML: (s) => s }) : void 0,
	ht = "$lit$",
	...
	y = document,
	k = () => y.createComment(""),
	C = (s) => s === null || (typeof s != "object" && typeof s != "function"),
	q = Array.isArray,
	kt = (s) =>
		q(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function",
	D = `[ 	
\f\r]`,
	x = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
	et = /-->/g,
...
\f\r"'\`<>=]|("|')|))|$)`,
	...
	ot = /'/g,
	st = /"/g,
	dt = /^(?:script|style|textarea|title)$/i,
	Ct =
		(s) =>
	...
	rt = new WeakMap(),
	$ = y.createTreeWalker(y, 129);
function ut(s, t) {
	if (!q(s) || !s.hasOwnProperty("raw"))
				...
				n === x
					? p[1] === "!--"
						...
						: p[1] !== void 0
							? (n = it)
							: p[2] !== void 0
								? (dt.test(p[2]) && (i = RegExp("</" + p[2], "g")), (n = b))
								: p[3] !== void 0 && (n = b)
					: n === b
						? p[0] === ">"
							? ((n = i ?? x), (h = -1))
							: p[1] === void 0
								? (h = -2)
								: ((h = n.lastIndex - p[2].length),
									(c = p[1]),
									(n = p[3] === void 0 ? b : p[3] === '"' ? st : ot))
						: n === st || n === ot
							? (n = b)
							: n === et || n === it
								? (n = x)
								: ((n = b), (i = void 0));
		const f = n === b && s[l + 1].startsWith("/>") ? " " : "";
		r +=
			n === x
				? a + St
				: h >= 0
					? (o.push(c), a.slice(0, h) + ht + a.slice(h) + g + f)
					: a + g + (h === -2 ? l : f);
	}
	return [
		ut(
			s,
			r + (s[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : ""),
		),
		o,
	];
};
	...
	constructor({ strings: t, _$litType$: e }, o) {
		...
		for (; (i = $.nextNode()) !== null && a.length < l; ) {
			if (i.nodeType === 1) {
					...
					for (const h of i.getAttributeNames())
						if (h.endsWith(ht)) {
							...
							a.push({
								...
								strings: f,
								ctor:
									H[1] === "." ? Ut : H[1] === "?" ? Mt : H[1] === "@" ? Ht : R,
							}),
								i.removeAttribute(h);
						} else
							h.startsWith(g) &&
								(a.push({ type: 6, index: r }), i.removeAttribute(h));
				if (dt.test(i.tagName)) {
					const h = i.textContent.split(g),
						u = h.length - 1;
					if (u > 0) {
				...
				if (i.data === ct) a.push({ type: 2, index: r });
				else {
					let h = -1;
					for (; (h = i.data.indexOf(g, h + 1)) !== -1; )
						a.push({ type: 7, index: r }), (h += g.length - 1);
				}
			r++;
		}
	}
...
function A(s, t, e = s, o) {
	...
	return (
		(i == null ? void 0 : i.constructor) !== r &&
			...
			r === void 0 ? (i = void 0) : ((i = new r(s)), i._$AT(s, e, o)),
			o !== void 0 ? ((e._$Co ?? (e._$Co = []))[o] = i) : (e._$Cl = i)),
		i !== void 0 && (t = A(s, i._$AS(s, t.values), i, o)),
		t
	);
}
class Ot {
	...
	u(t) {
		...
		for (; a !== void 0; ) {
			if (n === a.index) {
				let c;
				a.type === 2
					? (c = new M(r, r.nextSibling, this, t))
					: a.type === 1
						? (c = new a.ctor(r, a.name, a.strings, this, t))
						: a.type === 6 && (c = new zt(r, this, t)),
					this._$AV.push(c),
					(a = o[++l]);
			}
...
class M {
		...
		const { values: e, _$litType$: o } = t,
			i =
				typeof o == "number"
					? this._$AC(t)
					: (o.el === void 0 &&
							(o.el = P.createElement(ut(o.h, o.h[0]), this.options)),
						o);
	...
	k(t) {
		...
		for (const r of t)
			i === e.length
				? e.push((o = new M(this.O(k()), this.O(k()), this, this.options)))
				: (o = e[i]),
				o._$AI(r),
				i++;
	...
	_$AR(t = this._$AA.nextSibling, e) {
		var o;
		for (
			(o = this._$AP) == null ? void 0 : o.call(this, !1, !0, e);
			t && t !== this._$AB;
		) {
	...
	_$AI(t, e = this, o, i) {
		...
		if (r === void 0)
			...
			for (t = r[0], a = 0; a < r.length - 1; a++)
				(c = A(this, l[o + a], e, a)),
					c === w && (c = this._$AH[a]),
					n || (n = !C(c) || c !== this._$AH[a]),
					c === d ? (t = d) : t !== d && (t += (c ?? "") + r[a + 1]),
					(this._$AH[a] = c);
		}
		n && !i && this.j(t);
	}
...
const V = S.litHtmlPolyfillSupport;
V == null || V(P, M),
...
const Nt = (s, t, e) => {
	...
	if (i === void 0) {
		...
		o._$litPart$ = i = new M(t.insertBefore(k(), r), r, void 0, e ?? {});
	}
	return i._$AI(s), i;
}; /**
 * @license
...
(_._$litElement$ = !0),
	(_.finalized = !0),
	(nt = globalThis.litElementHydrateSupport) == null ||
		nt.call(globalThis, { LitElement: _ });
	...
	return (t, e) =>
		typeof e == "object"
			...
			: ((o, i, r) => {
					...
					return (
						i.constructor.createProperty(r, n ? { ...o, wrapped: !0 } : o),
						n ? Object.getOwnPropertyDescriptor(i, r) : void 0
					);
				})(s, t, e);
}
const gt = "/vite-lit-ts-tailwind-biome-poc/vite.svg",
...
var jt = Object.defineProperty,
	...
	K = (s, t, e, o) => {
		for (
			var i = o > 1 ? void 0 : o ? It(t, e) : t, r = s.length - 1, n;
			r >= 0;
			r--
		)
			(n = s[r]) && (i = (o ? n(t, e, i) : n(i)) || i);
		return o && i && jt(t, e, i), i;
	};
...
K([j()], O.prototype, "docsHint", 2);
K([j({ type: Number })], O.prototype, "count", 2);
O = K([ft("my-element")], O);
var Dt = Object.defineProperty,
	Vt = Object.getOwnPropertyDescriptor,
	J = (s, t, e, o) => {
		for (
			var i = o > 1 ? void 0 : o ? Vt(t, e) : t, r = s.length - 1, n;
			r >= 0;
			r--
		)
			(n = s[r]) && (i = (o ? n(t, e, i) : n(i)) || i);
		return o && i && Dt(t, e, i), i;
	};
...
J([j()], U.prototype, "docsHint", 2);
J([j({ type: Number })], U.prototype, "count", 2);
U = J([ft("my-other-element")], U);
